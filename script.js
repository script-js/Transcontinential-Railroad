...
function finish() {
  popout("<div style='text-align:center'><h1>Your Score: " + ((parseInt(money.innerHTML) - (parseInt(negative.innerHTML) * 100)) + (parseInt(positive.innerHTML) * 100)) + "</h1><a href='index.html'><button style='width:500px;padding:10px;'>Quit to Title</button></a></div>")
}
