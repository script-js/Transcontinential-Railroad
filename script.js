// Points: military boarding, broken treaty, winding railroad, inform people on culture, land stealing
...
var messages = ["<h1>Raid!</h1>A group of natives has raided one of your supply sheds!<p></p><button onclick='cAction(negative)'>Spread the word about how scary natives are</button><button onclick='cAction(positive)'>Leave it alone</button>","<h1>Attack!</h1>A group of natives has attacked a group of your workers! All of them were either wounded or killed.<p></p><button onclick='cAction(negative)'>Spread the word about how scary natives are</button><button onclick='cAction(positive)'>Leave it alone</button>","<h2>A group of Native Americans has informed you that you that the railroad is approaching their ancestral hunting grounds.</h2>You can change the route of the train, but it will cost you $50.<p></p><button onclick='cAction(positive,-20);moneyAdd(-20)'>Change Course</button><button onclick='cAction(negative)'>Continue Route</button>","<h2>The government has given you a plot of land that goes through native lands.</h2>If you accept it, you will save a lot of money.<p></p><button onclick='cAction(negative);addition = -2;'>Accept</button><button onclick='cAction(positive)'>Decline</button>","<h2>The government will pay you $200 if you allow a large group of military officers to get a train ride to deal with some &quot;issues&quot; with natives</h2><p></p><button onclick='cAction(negative);moneyAdd(200)'>Accept</button><button onclick='cAction(positive)'>Leave it alone</button>"]
var addition = 0;
